package bio.terra.annvarsearch.api;
...
import bio.terra.annvarsearch.controller.PublicApiController;
...
class PublicApiControllerTest {
  ...
  void testVersion() throws Exception {
    ...
    String github = "https://github.com/DataBiosphere/terra-annotated-variant-search/tree/0.9.0";
    String build = "0.1.0";
