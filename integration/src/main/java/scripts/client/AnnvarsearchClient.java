...
import bio.terra.annvarsearch.client.ApiClient;
...
public class AnnvarsearchClient extends ApiClient {
   ...
   */
  public AnnvarsearchClient(ServerSpecification server) throws IOException {
    this(server, null);
  }
   ...
   */
  public AnnvarsearchClient(ServerSpecification server, TestUserSpecification testUser)
      throws IOException {
